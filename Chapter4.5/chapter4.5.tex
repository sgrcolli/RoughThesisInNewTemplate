...
\begin{figure}[!h]
 ...
 \captionof{figure}{The generated angles for cosine direction W ($\cos(\theta)$) (z-axis) from the CRY library \cite{hagmann2007cosmic} for 1 million particles. Binning in CRY is 0.05 so an 8-dimensional polynomial was fitted to smooth the distribution.}
