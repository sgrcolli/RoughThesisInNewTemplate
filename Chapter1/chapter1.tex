...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{A combination of the fission fractions from \cite{Mueller_2011} and the first-order approximation of the cross-section from \cite{Vogel_1999} and how they evolve over the energy range where the two distributions cross over.}
