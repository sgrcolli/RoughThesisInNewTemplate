...
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Chapter5/Figs/Raster/dedxComarison.png}
...
\end{subfigure}
\caption{The measured $\theta$ distributions for Wylfa (shown in a) and Liverpool (shown in b) there's a peek at 60$^\circ$ in both and the overall reconstructed distributions look similar.}
