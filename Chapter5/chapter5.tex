...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{Layout and some slices from the three dimension tomograph showing the major features in the NCA image. From \cite{morris2014analysis}.} 
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{GEANT4 Monte Carlo simulation vs. data for a slice through the centre of the core. Top images with the projected region marked by green lines. Bottom plots of the areal density vs. horizontal position. From \cite{morris2014analysis}.}
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{A 3d image combined image from MT1, MT1-2, and MT2. The blue area represents NFSP and the green blocks represent areas of high density i.e spent fuel. From \cite{Fujii_ReactorRadiography_2019}.}
