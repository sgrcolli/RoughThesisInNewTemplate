...
\\\\Cosmic $\mu$ tomography would allow for positional reconstruction of a detectors surroundings. This positional reconstruction is useful because it guards against the detector from being forcible relocated. $\Bar{\nu_e}$ cannot be obscured due to their small cross section of 10$^{-42}$\,cm$^2$. As a result the only method to deceive an $\Bar{\nu_e}$ detector (bar tampering) is to relocate it. GPS trackers are a solution but can be potentially jammed therefore positional guarding via cosmic $\mu$ tomography is desirable. Considering the length of time to cycle power in reactors and thus remove fuel and by extension weapons grade material a time of 1\,hour was targeted to build sufficient statistics whilst being unobtrusive to reactor monitoring. Fortunately cosmic $\mu$ events were taken in accidental coincidence during the Wylfa deployment this afforded a fantastic opportunity to test the tomographic capabilities of the detector. To that end an overview of other detector was done to asses the limitations of this approach. 
...
\begin{figure}[!h]
 ...
 \captionof{figure}{$\mu$ imaging setup for Fukushima Daiichi Unit 2. FMT-2 is installed inside a concrete radiation shield in front of the reactor building. Typical $\mu$ scatting angles are a few degrees. From \cite{miyadera2013imaging}.} 
...
\begin{figure}[!h]
 ...
 \captionof{figure}{Left -- Lead reactor core with conic void. Right -- observed core where average scattering angles of $\mu$ are plotted. The void in the core is clearly image through 2.74\,m concrete walls. The lead core of 0.7\,m thickness gives and equivalent radiation length to the uranium fuel in unit 1, and gives a similar scattering angle. Hot spots at the corners are artefacts caused by edge effects. From \cite{miyadera2013imaging}.} 
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{Layout and some slices from the three dimension tomograph showing the major features in the NCA image \cite{morris2014analysis}.} 
  \label{fig:Toshiba3dTomogarphy}
  \vspace{3.1635cm}%1line = 0.6327cm exactly %%% 2lines = 1.2654cm %%% 3lines = 1.8981cm exactly %%% 4 lines is 2.5308cm exactly  %%% 5lines is 3.1635cm exactly
\end{minipage}%
\qquad
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Chapter5/Figs/MuTomographyExamples/toshibaG4Compare.jpg}
  \captionof{figure}{Comparison of reconstructed densities between the GEANT Monte Carlo simulation and the data for a slice through the centre of the core. Top images with the projected region marked by green lines. Bottom plots of the areal density vs. horizontal position for the Monte Carlo results blue and the data red. \cite{morris2014analysis}..}
...
\clearpage
\subsection{One-Sided Reactor Tomography}
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=0.8\linewidth]{Chapter5/Figs/MuTomographyExamples/Zed2OstSimulation.jpg}
 \captionof{figure}{. From \cite{Erlandson_reactorOST_2018}.} 
 \label{fig:Zed2OstSimulation}
\end{figure}

\begin{figure}[!h]
 \centering
 \includegraphics[width=0.5\linewidth]{Chapter5/Figs/MuTomographyExamples/JapcNuclearPowerImaging.jpg}
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=0.7\linewidth]{Chapter5/Figs/MuTomographyExamples/MtAsma1dExplanation.jpg}
...
\begin{figure}[!h]
 \centering
 \includegraphics[width=0.7\linewidth]{Chapter5/Figs/MuTomographyExamples/mtAsma3dMap.jpg}
...
\subsection{DIAPHANE $\mu$ Radiography} \label{sec:DIAPHANEmuRadiography}
...
% \begin{minipage}{.45\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{Chapter5/Figs/Raster/muRayDetectors.png}
%   \captionof{figure}{The MU-RAY detector frame with the three X–Y planes mounted. The frame can be oriented using the rotating platform visible at the bottom. From \cite{ANASTASIO2013423}.} 
%   \label{fig:muRayDetectors}
% \end{minipage}%
% \qquad
% \begin{minipage}{.45\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{Chapter5/Figs/Raster/mtVesuviusMuRayImaging.png}
