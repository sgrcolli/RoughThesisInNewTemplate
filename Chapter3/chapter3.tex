...
This chapter will discuss the Liverpool prototype and its upgrade to the VIDARR detector system. The initial basis for the detector, the T2K ND 280 (near detector at 280\,m) Electromagnetic Calorimeter (ECal) will also be covered. As well as a brief mention of the background at reactor sites. The upgrade progressed steadily until December 2019. Despite the ongoing uncertainty the detector has had a $\sim$ 50\,\% increase in mass and new cooling system and mobile container laboratory. At time of writing the electronics are currently being upgraded. 
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{A view of the electronics in the initial detector. There is much available space between the boards and the detector itself. The cables are 100\,mm long.} 
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{The detector being taken out of the original shipping container which was a standard cooled shipping container.}
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{Plastic holder next to MPPC and PCB (Top) and holder with assembled components (Bottom). Note the MPPC in the top right is actually reversed from its correct orientation, the prongs of the MPPC go through the PCB board pins.} 
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{The plastic holder is connected to a cable and put inside a sheath.}
