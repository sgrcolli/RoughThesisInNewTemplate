...
\\\\Reducing the errors on the mixing angles has been ongoing in neutrino physics. As a result, there are many experiments that have contributed to the improvements in angles which can be seen in figure \ref{neutrino_angles_experiments_variations} 
...
\begin{figure}[!h]
 ...
 \captionof{figure}{The regions of squared-mass splitting and mixing angle favoured or excluded by various experiments based on two-flavour neutrino oscillation analyses. References to the data can be found in \cite{berklyNeutrinoLink}. From \cite{Olive_2014}.} %~can be used as a kind of place holder in latex
