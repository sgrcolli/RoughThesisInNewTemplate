...
\begin{figure}[!h]
 ...
 \captionof{figure}{The possible process of oscillations to a sterile state at small distances from an active zone of the reactor. From \cite{neutrino4_2021}.} 
...
\section{Reactor Neutrino Anomaly}
In figure \ref{fig:neutrino4Plot} between 10\,m -- 100\,m there is an area dedicated to the reactor neutrino anomaly  

\section{5\,MeV Reactor ``Bump''}
