...
\begin{figure}[!h]
 \centering
 \includegraphics[height=70mm]{Chapter1/Figs/Raster/less_detailed_proper_path.png}
...
\end{equation}
Note that for equation \ref{linear_combination_eq_9} and equation \ref{linear_combination_eq_10} that $E = p$, these equations also have to be averaged over the energy distribution of particles involved. Also, the assumption that the $\mu$ neutrino is created with a definite momentum p is only an approximation \cite{sassaroli1999neutrino}. This explanation follows \cite{sassaroli1999neutrino} which also gives the full quantum mechanical treatment as well. If we take equation \ref{linear_combination_eq_9} we can see that at a distance $L = (4E\pi) / (m_1^2 - m_2^2)$ there will be a maximum conversion to electron neutrinos and at $2L$ there will be a maximum conversion to $\mu$ neutrinos. When converting to MeV/m from natural units the equations \ref{equ:peToPmu} and \ref{equ:pmuToPe} are produced. When modelling energies in figure \ref{fig:probabilityNeutrinoTransition} for reactor monitoring a detector needs to be placed at $\sim$ 1000\,m to measure neutrinos. In \ref{subFig:0.1MevNeutrinoTransitionProb} a neutrino of 0.1\,MeV is modelled to show how even with a neutrino energy 1/18$^{th}$ of the expected minimal energy oscillations would not be a significant concern for near-field reactor monitoring. 
...
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Chapter2/Figs/0.1MevNeutrinoTransitionProb.png}
  \captionsetup{width=.9\linewidth}
  \caption{}
  \label{subFig:0.1MevNeutrinoTransitionProb}
\end{subfigure}%
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Chapter2/Figs/1MevNeutrinoTransitionProb.png}
  \captionsetup{width=.9\linewidth}
  \caption{}
  \label{subFig:1MevNeutrinoTransitionProb}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Chapter2/Figs/1.8MevNeutrinoTransitionProb.png}
  \captionsetup{width=.9\linewidth}
  \caption{}
  \label{subFig:1.8MevNeutrinoTransitionProb}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Chapter2/Figs/10MevNeutrinoTransitionProb.png}
  \captionsetup{width=.9\linewidth}
  \caption{}
  \label{subFig:10MevNeutrinoTransitionProb}
\end{subfigure}
\caption{Probability of flavour transition for neutrinos at differing energies and lengths. In (a) a neutrino with 0.1\,MeV is modelled. In (b) neutrino of 1\,MeV is modelled. In (c) a neutrino 1.8\,MeV is modelled. In (d) a neutrino with 10\,MeV is modelled. This shows between 1.8\,MeV (c) -- 10\,MeV (d) a detector needs to be $\sim$ 1000\,m from the reactor before oscillations can be measured. For near-field reactor monitoring ($\sim$ 50\,m) even neutrino energies of 0.1\,MeV would lead to minimal oscillations. But the threshold for possible neutrinos is $\sim$ 1.8\,MeV in a neuclear reactor \cite{Mueller_2011}.}
