...
\begin{figure}[htbp]
 ...
 \captionof{figure}{The time taken for the neutron from the simulated $\bar{\nu_e}$ inverse $\beta$ decay event to thermilise and be absorbed by the Gadolinium sheets in the simulated VIDARR detector. The tail is extremely long, lasting 1E5\,ns (100\,$\mu$s) after the initial peak.} 
...
muons and pions, are not included. From \cite{Olive_2014}.} 
...
\begin{figure}[htbp]
 ...
 \captionof{figure}{The attenuation plot from the single bar test stand produced by George Holt. The attenuation length (amount of bar traversed to lose $\sim$ 63\,\%  of light, $\lambda$ in equation \ref{equ:attenuationFunction}) is 580 $\pm$ 60\,PE/cm.} 
