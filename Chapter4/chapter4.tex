...
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/svmLinSepExample.png}
%   \captionsetup{width=.9\linewidth}
%   \caption{An SVM with no kernel separating two data sets that have no overlap.}
%   \label{subFig:svmLinSepExample}
% \end{subfigure}%
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/svmLinNoSepExample.png}
%   \captionsetup{width=.9\linewidth}
%   \caption{An SVM with no kernel separating two data sets that have a small overlap.}
%   \label{subFig:svmLinNoSepExample}
% \end{subfigure}
% \caption{SVM examples showing how to separate two data sets using linear boundaries.}
% \label{fig:svmLinExamples}
% \end{figure}
...
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/svmCircleSepExample.png}
%   \captionsetup{width=.9\linewidth}
%   \caption{An SVM with an RBF kernel separating two data steps with no overlap.}
%   \label{subFig:svmCircleSepExample}
% \end{subfigure}%
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/svmCircleNoSepExample.png}
%   \captionsetup{width=.9\linewidth}
%   \caption{An SVM with an RBF kernel separating two data steps with a small overlap.}
%   \label{subFig:svmCircleNoSepExample}
% \end{subfigure}
% \caption{SVM examples showing how to separate two data sets using circular boundaries.}
% \label{fig:svmCircleExamples}
% \end{figure}
...
\captionof{figure}{Accuracy of an SVM with a radial basis function (RBF) kernel as more dimensions are added for a $\gamma$ value of 0.01. The results do not converge when all the dimensions are considered suggesting the global minimum of the SVM has not been found.} %~can be used as a kind of place holder in latex
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/accNeutronRbfSVMg0.001.png}
\captionof{figure}{Accuracy of an SVM with a radial basis function (RBF) kernel as more dimensions are added for a $\gamma$ value of 0.001. The SVM has almost converged but the final result still has a slight drop suggesting that improvements need to be made.} %~can be used as a kind of place holder in latex
\label{fig:accNeutronRbfSVMg0.001}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/accNeutronRbfSVMg0.00001.png}
\captionof{figure}{Accuracy of an SVM with a radial basis function (RBF) kernel as more dimensions are added for a $\gamma$ value of 0.00001. The SVM has converged the accuracy levels off after 2 dimensions and there is no drop afterwards this clearly shows that the data is 2d separable and that there is no further improvement to be made to the SVM.} %~can be used as a kind of place holder in latex
\label{fig:accNeutronRbfSVMg0.00001}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/accNeutronLinSVM.png}
\captionof{figure}{Accuracy for an SVM with no kernel the SVM has converged after 2 dimensions and resembles figure \ref{fig:accNeutronRbfSVMg0.00001} which shows that the results are 2d linearly separable.} %~can be used as a kind of place holder in latex
\label{fig:accNeutronLinSVM}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/effNeutronLinSVM.png}
\captionof{figure}{Efficiency of the neutron signal (the 8\,MeV $\gamma$ cascade) for an SVM with no kernel for different combinations of 4 dimensions. The efficiency peaks after two dimensions.} %~can be used as a kind of place holder in latex
\label{fig:effNeutronLinSVM}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Chapter4/Figs/Raster/svmLinAndRbf/purNeutronLinSVM.png}
\captionof{figure}{Purity of the neutron signal (the 8\,MeV $\gamma$ cascade) for an SVM with no kernel for different combinations of 4 dimensions. The purity peaks after two dimensions} %~can be used as a kind of place holder in latex
\label{fig:purNeutronLinSVM}
\end{figure}
...
\begin{figure}[H]
 ...
 \captionof{figure}{The summed energy past the simulated neutron trigger shown in figure \ref{fig:signalAndNoiseNeutronLinSVM}. 25\,PE = 1\,MeV overall giving an Efficiency = 76\,\% and purity = 92\,\%. Purity is determined from noise of 4 million noise evetns and 1 million signal events.} %~can be used as a kind of place holder in latex
