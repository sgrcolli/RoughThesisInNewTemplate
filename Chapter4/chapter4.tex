...
\begin{subfigure}{.5\textwidth}
  ...
  \captionsetup{width=.9\linewidth}
  \caption{Energies of single $\gamma$ rays from the photon evaporation model in Geant 4 this conserves energy but does not have high energy $\gamma$ rays that are typically associated with natural gadolinium.\hl{source req!} }
...
\begin{subfigure}{.5\textwidth}
  ...
  \captionsetup{width=.9\linewidth}
  \caption{Energies of the $\gamma$ rays from the final state model in Geant 4 this shows the high energy gamma rays from both $^{157}$Gd and $^{155}$Gd however this does break the conservation of energy. from \hl{source req!}}
